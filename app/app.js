(function() {
  ...
  app.controller('PlayerController', ['$scope', '$http', 'loginService', 'groupService', 'playerService', 'player180Service', 'fixtureService', 'resultService', 'highFinishService', 'bestLegService', 'dialogs', 'toastr', 'toastrConfig',
  function($scope, $http, loginService, groupService, playerService, player180Service, fixtureService, resultService, highFinishService, bestLegService, dialogs, toastr, toastrConfig) {
    var playerCtrl = this;
  ...
  app.controller('WeekController', ['$scope', '$http', 'loginService', 'weekService', 'fixtureService', 'resultService', 'player180Service', 'highFinishService', 'bestLegService', 'dialogs', 'toastr', 'toastrConfig', 
  function($scope, $http, loginService, weekService, fixtureService, resultService, player180Service, highFinishService, bestLegService, dialogs, toastr, toastrConfig) {
    var weekCtrl = this;
  ...
  app.controller('VenueController', ['$scope', '$http', 'venueService', 'fixtureService', 'resultService', 'player180Service', 'highFinishService', 'bestLegService', 'loginService', 'dialogs', 'toastr', 'toastrConfig',
  function($scope, $http, venueService, fixtureService, resultService, player180Service, highFinishService, bestLegService, loginService, dialogs, toastr, toastrConfig) {
    var venueCtrl = this;
